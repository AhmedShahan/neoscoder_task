...
<style>
    ...
    .stage-card {
        ...
        margin: 1rem 0;
        color: black; /* Black text for white/light background */
    }
    .conversation-item {
        background: #ffffff;
        padding: 1rem;
    ...
    .doctor-message {
        ...
        color: black; /* Black text for light blue background */
    }
    .patient-message {
        border-left-color: #28a745 !important;
        background: #e8f5e8 !important;
        color: black; /* Black text for light green background */
    }
    .alert-high {
        background: #f8d7da;
        border-left-color: #dc3545;
        color: black; /* Black text for light red background */
    }
    .alert-moderate {
        background: #fff3cd;
        border-left-color: #ffc107;
        color: black; /* Black text for light yellow background */
    }
    .alert-low {
        background: #d1ecf1;
        border-left-color: #17a2b8;
        color: black; /* Black text for light cyan background */
    }
    .prescription-card {
...
def initialize_session_state():
    ...
    if 'prescription_confirmed' not in st.session_state:  # New session state for confirmation
...
def render_alerts_stage():
    ...
    with col3:
        ...
        if high_risk_alerts:
            ...
            if st.button("✅ Confirm Prescription", key="confirm_prescription_with_alerts", use_container_width=True):
        ...
        <div class="prescription-card">
            ...
            <div style="display: flex; justify-content: space-between; margin: 1rem 0;">
                ...
                <div>
                    ...
                    <strong>Doctor:</strong> Dr. [Sinthiya Chowdhuty]<br>
...
\\textbf{{Patient:}} {escape_latex(prescription.get('patient_name', 'Not provided'))} \\\\
\\textbf{{Age:}} {escape_latex(prescription.get('age', 'Not provided'))} \\\\
\\textbf{{Gender:}} {escape_latex(prescription.get('gender', 'Not provided'))}
\\end{{minipage}}
\\begin{{minipage}}[t]{{0.45\\textwidth}}
\\textbf{{Date:}} {escape_latex(prescription.get('date', datetime.now().strftime('%Y-%m-%d')))} \\\\
...
"""
        ...
        with col4:
            consultation_time = len(st.session_state.transcription) * 0.5 if st.session_state.transcription else 0
